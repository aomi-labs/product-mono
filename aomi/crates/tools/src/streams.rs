...
type ToolResultItem = (String, Result<Value, String>);
type ToolResultOneshot = oneshot::Receiver<ToolResultItem>;
type ToolResultChannel = mpsc::Receiver<ToolResultItem>;

fn split_first_chunk_and_rest(
    call_id: String,
    mut multi_rx: mpsc::Receiver<Result<Value>>,
) -> (ToolResultOneshot, ToolResultChannel) {
